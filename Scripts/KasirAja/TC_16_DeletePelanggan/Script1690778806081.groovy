...
WebUI.verifyElementPresent(findTestObject('KasirAja/Login/verify_home'), 2)

WebUI.click(findTestObject('KasirAja/Pelanggan/btn_pelanggan'))

WebUI.click(findTestObject('KasirAja/Pelanggan/btn_titikmenu'))

WebUI.click(findTestObject('KasirAja/Pelanggan/btn_hapus'))

WebUI.click(findTestObject('KasirAja/Pelanggan/btn_delete'))
